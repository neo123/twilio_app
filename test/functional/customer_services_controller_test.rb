...
class CustomerServicesControllerTest < ActionController::TestCase
  ...
  test "should create customer_service" do
    assert_difference('CustomerService.count') do
      post :create, customer_service: { customer_id: @customer_service.customer_id, order: @customer_service.order, quantity: @customer_service.quantity, service_id: @customer_service.service_id }
    end
  ...
  test "should update customer_service" do
    put :update, id: @customer_service, customer_service: { customer_id: @customer_service.customer_id, order: @customer_service.order, quantity: @customer_service.quantity, service_id: @customer_service.service_id }
    assert_redirected_to customer_service_path(assigns(:customer_service))
  end
